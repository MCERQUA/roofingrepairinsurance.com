...
import { ShieldCheck, HardHat, Truck, Wrench, Award, Building2, Umbrella, Droplets, ArrowRight } from "lucide-react";

const ICONS = {
  ShieldCheck, HardHat, Truck, Wrench, Award, Building2, Umbrella, Droplets,
} as const;
